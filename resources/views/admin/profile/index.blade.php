    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.profile.update', ['profile' => auth()->id()]) }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group">
                            <label class="required" for="title">Image </label>
                            <input class="form-control {{ $errors->has('image') ? 'is-invalid' : '' }}" type="file"
                                name="image" id="image" value="{{ old('image', auth()->user()->image) }}" required>
                            @if ($errors->has('image'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('image') }}
                                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.profile.destroy', ['profile' => auth()->id()]) }}"
